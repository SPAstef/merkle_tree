 ...
 *****************************************************************************
 ...
 Declaration of interfaces for top-level SHA512 gadgets.
...
namespace libsnark
{
    namespace sha512
    {
        ...
        /**
 * Gadget for the SHA512 compression function.
 */
        template<typename FieldT>
        class sha512_compression_function_gadget : public gadget<FieldT>
        {
        public:
            ...
            std::shared_ptr<sha512_message_schedule_gadget<FieldT>> message_schedule;
            std::vector<sha512_round_function_gadget<FieldT>> round_functions;
        ...
        public:
            ...
            sha512_compression_function_gadget(
                protoboard<FieldT> &pb, const pb_linear_combination_array<FieldT> &prev_output,
        ...
        /**
 * Gadget for the SHA512 compression function, viewed as a 2-to-1 hash
 * function, and using the same initialization vector as in SHA512
 * specification. Thus, any collision for
 * sha512_two_to_one_hash_gadget trivially extends to a collision for
 * full SHA512 (by appending the same padding).
 */
        template<typename FieldT>
        class sha512_two_to_one_hash_gadget : public gadget<FieldT>
        {
        public:
            ...
            sha512_two_to_one_hash_gadget(protoboard<FieldT> &pb,
                                          const digest_variable<FieldT> &left,
                                          const digest_variable<FieldT> &right,
                                          const digest_variable<FieldT> &output,
                                          const std::string &annotation_prefix);
            sha512_two_to_one_hash_gadget(protoboard<FieldT> &pb, const size_t block_length,
