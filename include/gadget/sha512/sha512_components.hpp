 ...
 *****************************************************************************
 ...
 Declaration of interfaces for gadgets for the SHA512 message schedule and round function.
...
#ifndef SHA512_COMPONENTS_HPP_
#define SHA512_COMPONENTS_HPP_
...
namespace libsnark
{
    namespace sha512
    {
        const size_t SHA512_digest_size = 512; //
        const size_t SHA512_block_size = 1024; //

        template<typename FieldT>
        pb_linear_combination_array<FieldT> SHA512_default_IV(protoboard<FieldT> &pb);

        template<typename FieldT>
        class sha512_message_schedule_gadget : public gadget<FieldT>
        {
        public:
        ...
        public:
            ...
            sha512_message_schedule_gadget(protoboard<FieldT> &pb,
        ...
        template<typename FieldT>
        class sha512_round_function_gadget : public gadget<FieldT>
        {
        public:
        ...
        public:
            ...
            sha512_round_function_gadget(protoboard<FieldT> &pb,
                                         ...
                                         const pb_variable<FieldT> &W, const long &K,
